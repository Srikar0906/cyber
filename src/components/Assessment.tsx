                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-8 relative z-10">
                    ...
                    <button
                      ...
                      className={`flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-bold transition-all active:scale-95 shadow-sm hover:shadow-md ${isCorrect ? 'bg-emerald-200/50 dark:bg-emerald-800/30 text-emerald-800 dark:text-emerald-300 hover:bg-emerald-200 dark:hover:bg-emerald-800/50' : 'bg-rose-200/50 dark:bg-rose-800/30 text-rose-800 dark:text-rose-300 hover:bg-rose-200 dark:hover:bg-rose-800/50'}`}
                      aria-expanded={isExplanationVisible}
                    >
                      {isExplanationVisible ? 'Hide Insight' : 'Read Insight'}
                      <motion.div animate={{ rotate: isExplanationVisible ? 180 : 0 }} transition={{ type: "spring", bounce: 0.4 }}>
